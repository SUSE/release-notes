...
For installation documentation, see the __Deployment Guide__ at {doc-url}/html/SLED-all/book-sle-deployment.html.
endif::[]
...
// disclaimer maintained
ifeval::["{lifecycle}" == "maintained"]
For upgrade documentation, see the __Upgrade Guide__ at {doc-url}/html/SLED-all/book-sle-upgrade.html.
endif::[]
// disclaimer unmaintained
ifeval::["{lifecycle}" == "unmaintained"]
