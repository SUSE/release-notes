...
* `rasdaemon` has been updated to version 0.8.4, which supports machine checks related to CXL memory. Since Intel® Optane™ Memory products have reached End of Life (EOL), {productname} {this-version} does not support them either.
