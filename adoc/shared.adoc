...
* files created by new users are technically group-readable but because each user has its own group, this does not make them readable to the group; however, others still have a read permission, making the files readable to anyone
