...
For web-based management of a single node, {cockpit} is included. For details, refer to https://documentation.suse.com/sle-micro/{this-version}/html/SLE-Micro-all/article-administration-slemicro.html#sec-admin-{cockpit}.
