...
include::../shared.adoc[tags=jscped-12809,leveloffset=+3]

[#power]
=== Power-specific changes (ppc64le)

Information in this section applies to {productname} {this-version} on IBM Power.

// jsc#PED-11140
* Linux is now supported as a KVM host on IBM Power
