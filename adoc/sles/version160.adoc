...
// jsc#PED-12658
* `rasdaemon` has been updated to version 8.3.0. This version supports machine checks related to CXL memory. Since Intel® Optane™ Memory products have reached End of Life (EOL) and are no longer supported on 12th Generation (or newer) Intel® Core™ processors, this is also true for {productname} {this-version}.
// jsc#PED-12283
