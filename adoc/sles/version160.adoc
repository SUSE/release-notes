...
If {productname} {this-version} has been installed, the configuration parameter `SECURE_BOOT` in `/etc/sysconfig/bootloader` is automatically set to `yes`, although the used hardware supports Secure Boot from ECKD DASD.
