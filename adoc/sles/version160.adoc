...
// jsc#PED-12658
* `rasdaemon` has been updated to version 8.3.0. This version supports machine checks related to CXL memory. Since Intel® Optane™ Memory products have reached End of Life (EOL), {productname} {this-version} officially not support them as well.
// jsc#PED-12283
