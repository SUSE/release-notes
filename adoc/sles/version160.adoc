...
As technology prevew, an AI agent using Model Context Protocol (MCP) standard called `mcphost` is available in {productname} {this-version}.
...
include::../shared.adoc[tags=jscped-12739,leveloffset=+3]

// switch to predictable network names
include::../shared.adoc[tags=jscped-12725,leveloffset=+3]
