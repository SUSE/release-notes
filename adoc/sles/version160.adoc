...
It was added by accident to {productname} 16.0, but it is unsupported as there is no maintainer and it does not fit the observability story to ship a server component.
