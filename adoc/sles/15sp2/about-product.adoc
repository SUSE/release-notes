...
* FIPS 140-2 validation, see https://csrc.nist.gov/groups/STM/cmvp/documents/140-1/140InProcess.pdf
...
For more information, check our Support Policy page https://www.suse.com/support/policy-products/ or the Long Term Service Pack Support Page https://www.suse.com/products/long-term-service-pack-support/.
