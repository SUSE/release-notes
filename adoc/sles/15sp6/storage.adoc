...
[#jsc-PED-7980]
==== Reusing LVM no longer default

The installer no longer tries to re-use existing LVM configurations.
See the _Deployment Guide_ at {doc-url-auto}/single-html/SLES-deployment/#yast-installer-reuse-lvm for more information.
...
For more information see the Partioning section of the _{autoyast} Guide_ at {doc-url-auto}/single-html/SLES-autoyast/#CreateProfile-Partitioning
