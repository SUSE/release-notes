...
As a technology preview, remote and local attestation for AMD and Intel are available via the following packages in {productname} {this-version}:
...
This will be moved forward to support statement after full validation.
...
The following AMD Secure Encrypted Virtualization SNP tools have been updated:
