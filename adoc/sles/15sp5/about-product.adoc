...
{productname}{nbsp}{this-version} will not be submitted for certification to either Common Criteria or NIST FIPS 140-3.
As a practice, {suse} only submits even-numbered Service Packs (for example: {productnameshort} 15, SP2, SP4, etc.) for certification.
...
{productname}{nbsp}{this-ga} has a 13-year life cycle, with 10 years of General Support and three years of Extended Support.
The current version ({this-sp}) will be fully maintained and supported until six months after the release of {productname}{nbsp}{this-ga}{nbsp}{next-sp}.
