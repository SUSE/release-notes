...
* FIPS 140-2 validation, see https://csrc.nist.gov/projects/cryptographic-module-validation-program/modules-in-process/modules-in-process-list
...
For more information, see the pages https://www.suse.com/support/policy-products/[Support Policy] and https://www.suse.com/products/long-term-service-pack-support/[Long Term Service Pack Support].
