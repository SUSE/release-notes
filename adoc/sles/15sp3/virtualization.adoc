...
QEMU has been updated toversion 5.2.
...
For more information, see the https://wiki.xenproject.org/wiki/Xen_Project_4.14_Feature_List[upstream Xen release notes].
...
For more information, see the https://libvirt.org/news.html[upstream libvirt release notes].
...
For more information, see the https://gitlab.freedesktop.org/spice/spice-protocol/-/blob/master/CHANGELOG.md[upstream change log].
...
The XML editor can be used instead.
...
For more information, see the https://github.com/vmware/open-vm-tools/blob/stable-11.2.5/open-vm-tools/ChangeLog[upstream change log].
