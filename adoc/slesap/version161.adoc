:this-version: 16.1
:idprefix: v161_
:doc-url: https://documentation.suse.com/sles-sap/16.1
...
// jsc#PED-13633
* The migration tool fixes deprecated PAM configuration entries from older SAP Host Agent installations. See the __SAP Host Agent PAM configuration fixed during migration__ note in the {sles} release notes for details.
