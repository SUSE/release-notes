...
// jsc#PED-13633
* The migration tool fixes deprecated PAM configuration entries from older SAP Host Agent installations. See <<jsc-PED-13633>> in the {sles} release notes for details.
